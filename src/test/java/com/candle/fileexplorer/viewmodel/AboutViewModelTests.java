...
public class AboutViewModelTests {
    ...
    public void getFilesVersion_shouldReturnVersion_WhenCalled() {
        // TODO: Make this test future proof. I don't see how to test this
        //  except by hard coding the correct result.
    ...
    public void getJavaFxVersion_shouldReturnVersion_whenCalled() {
        AboutViewModel viewModel = new AboutViewModel();
        Assertions.assertEquals(viewModel.getJavaFxVersion(),
    ...
    public void getJavaVersion_shouldReturnVersion_whenCalled() {
        AboutViewModel viewModel = new AboutViewModel();
        Assertions.assertEquals(viewModel.getJavaVersion(),
